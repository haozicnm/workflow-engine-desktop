...
export const NODE_REGISTRY: NodeDefinition[] = [
  ...
  // ═══════════════════════════════════════════
  {
    ...
    inputs: [],
    outputs: [
      { id: 'data', label: '数据', type: 'array' },
      { id: 'sheet', label: '工作表', type: 'string' },
    ],
    defaultConfig: { path: '', sheet: '' },
  },
  {
    type: 'excel_write',
    label: '写入表格',
    ...
    inputs: [{ id: 'data', label: '数据', type: 'array' }],
    outputs: [{ id: 'path', label: '路径', type: 'string' }],
    defaultConfig: { path: '', sheet: 'Sheet1', write_mode: 'overwrite' },
  },
  {
    type: 'excel_create',
    label: '创建表格',
    ...
    inputs: [{ id: 'data', label: '数据', type: 'array' }],
    outputs: [{ id: 'path', label: '路径', type: 'string' }],
    defaultConfig: { path: '新表格.xlsx', sheet: 'Sheet1', headers: '' },
  },
  {
    type: 'excel_filter',
    label: '筛选数据',
    ...
    color: '#4ADE80',
    category: 'excel',
    description: '按条件筛选表格行',
    inputs: [
      { id: 'data', label: '数据', type: 'array' },
      { id: 'condition', label: '条件', type: 'object' },
    ],
    outputs: [{ id: 'result', label: '结果', type: 'array' }],
    defaultConfig: { column: '', op: '==', value: '' },
  },
  {
    type: 'excel_sort',
    label: '排序数据',
    ...
    inputs: [{ id: 'data', label: '数据', type: 'array' }],
    outputs: [{ id: 'result', label: '结果', type: 'array' }],
    defaultConfig: { column: '', order: 'asc' },
  },
  {
    type: 'excel_append',
    label: '追加行',
  ...
  // ═══════════════════════════════════════════
  {
    ...
    outputs: [
      ...
      { id: 'paragraphs', label: '段落', type: 'array' },
    ],
    defaultConfig: { path: '' },
  },
  {
    ...
    color: '#60A5FA',
    category: 'word',
    description: '将内容写入 Word 文档',
    inputs: [{ id: 'content', label: '内容', type: 'string' }],
    outputs: [{ id: 'path', label: '路径', type: 'string' }],
  ...
  },
  {
    ...
    inputs: [{ id: 'content', label: '内容', type: 'string' }],
    outputs: [{ id: 'path', label: '路径', type: 'string' }],
    defaultConfig: { path: '新文档.docx', title: '' },
  },
  {
    type: 'word_replace',
    label: '查找替换',
    ...
    defaultConfig: { path: '', find: '', replace: '', count: 0 },
  },
  {
    type: 'word_merge',
    label: '合并文档',
    ...
    inputs: [{ id: 'files', label: '文件列表', type: 'array' }],
    outputs: [{ id: 'path', label: '路径', type: 'string' }],
    defaultConfig: { paths: '', output: '合并文档.docx' },
  },
  {
    type: 'word',
    label: 'Word(通用)',
  ...
  // ═══════════════════════════════════════════
  {
    ...
    inputs: [
      ...
      { id: 'body', label: '请求体', type: 'object' },
    ],
    outputs: [{ id: 'result', label: '结果', type: 'object' }],
    defaultConfig: { url: '', method: 'GET' },
  },
  {
    type: 'file',
    ...
    inputs: [],
    outputs: [
      { id: 'content', label: '内容', type: 'string' },
      { id: 'bytes', label: '字节', type: 'file' },
    ],
  ...
  },
  {
    ...
    inputs: [{ id: 'input', label: '输入', type: 'object', required: true }],
    outputs: [{ id: 'result', label: '结果', type: 'object' }],
  ...
  },
  {
    ...
    color: '#C084FC',
    category: 'data',
    description: '用正则表达式提取/替换文本',
    inputs: [{ id: 'input', label: '输入', type: 'string', required: true }],
    outputs: [
      { id: 'matches', label: '匹配', type: 'array' },
  ...
  },
  {
    ...
    inputs: [{ id: 'input', label: '输入', type: 'array', required: true }],
    outputs: [{ id: 'result', label: '结果', type: 'array' }],
  ...
  },
  {
    ...
    inputs: [{ id: 'data', label: '数据', type: 'object' }],
    outputs: [{ id: 'result', label: '结果', type: 'string' }],
  ...
  // ═══════════════════════════════════════════
  {
    ...
    color: '#f97316',
    category: 'logic',
    description: '遍历数组，对每个元素执行操作',
    inputs: [{ id: 'items', label: '列表', type: 'array', required: true }],
    outputs: [
      { id: 'results', label: '结果集', type: 'array' },
  ...
  },
  {
    ...
    inputs: [{ id: 'items', label: '列表', type: 'array' }],
    outputs: [
      { id: 'results', label: '结果集', type: 'array' },
      { id: 'count', label: '计数', type: 'number' },
      { id: 'stopped_at', label: '停止位置', type: 'number' },
    ],
  ...
  },
  {
    ...
    inputs: [
      { id: 'left', label: '左值', type: 'any' },
      { id: 'right', label: '右值', type: 'any' },
    ],
    outputs: [
      { id: 'result', label: '结果', type: 'boolean' },
      { id: 'branch', label: '分支', type: 'string' },
    ],
  ...
  },
  {
    ...
    inputs: [],
    outputs: [{ id: 'duration_ms', label: '时长(ms)', type: 'number' }],
  ...
  },
  {
    ...
    color: '#fb923c',
    category: 'logic',
    description: '打包一组节点为可复用子流程',
    inputs: [{ id: 'input', label: '输入', type: 'object' }],
    outputs: [{ id: 'result', label: '结果', type: 'object' }],
  ...
  },
  {
    ...
    inputs: [{ id: 'items', label: '列表', type: 'array' }],
    outputs: [{ id: 'results', label: '结果集', type: 'array' }],
  ...
  // ═══════════════════════════════════════════
  {
    ...
    inputs: [{ id: 'content', label: '内容', type: 'object', required: true }],
    outputs: [{ id: 'path', label: '路径', type: 'string' }],
  ...
  },
  {
    ...
    inputs: [{ id: 'data', label: '数据', type: 'any', required: true }],
    outputs: [{ id: 'pass', label: '透传', type: 'any' }],
  ...
  // ═══════════════════════════════════════════
  {
    ...
    color: '#ec4899',
    category: 'other',
    description: '运行自定义 Python/Shell 脚本',
    inputs: [{ id: 'input', label: '输入', type: 'any' }],
    outputs: [{ id: 'result', label: '结果', type: 'any' }],
